...
public class ArithmeticEvaluatorTest {
  ...
  public void evaluateDoubleShouldReturnDoubleAdd() throws Exception {
    Token<Integer> l = Mockito.mock(Token.class);
    Mockito.when(l.getValue()).thenReturn(1);

    Token<Double> r = Mockito.mock(Token.class);
    Mockito.when(r.getValue()).thenReturn(2D);
  ...
  public void evaluateIntegerShouldReturnIntegerAdd() throws Exception {
    ...
    Token<Integer> r = Mockito.mock(Token.class);
    Mockito.when(r.getValue()).thenReturn(2);
  ...
  public void evaluateFloatsShouldReturnFloatAdd() throws Exception {
    Token<Float> l = Mockito.mock(Token.class);
    Mockito.when(l.getValue()).thenReturn(1F);
  ...
  public void evaluateLongsShouldReturnLongAdd() throws Exception {
    Token<Long> l = Mockito.mock(Token.class);
    Mockito.when(l.getValue()).thenReturn(1L);
  ...
  public void evaluateShouldThroughIllegalArgumentExceptionWhenInputsKeyIsNull() throws Exception {
    Pair<Token<? extends Number>, Token<? extends Number>> p = Pair.of(null, Mockito.mock(Token.class));
  ...
  public void evaluateShouldThroughIllegalArgumentExceptionWhenInputsValueIsNull() throws Exception {
    Pair<Token<? extends Number>, Token<? extends Number>> p = Pair.of(Mockito.mock(Token.class), null);
    evaluator.evaluate(ArithmeticEvaluator.ArithmeticEvaluatorFunctions.division(), p);
  }

  @Test
  public void evaluateShouldConvertShortsToIntegersType() throws Exception {
    Token<Short> l = Mockito.mock(Token.class);
    Mockito.when(l.getValue()).thenReturn((short) 2);

    Token<Short> r = Mockito.mock(Token.class);
    Mockito.when(r.getValue()).thenReturn((short) 3);
  ...
  public void evaluateIntegerShouldReturnIntegerWhenLeftsValueIsNull() throws Exception {
    Token<Integer> l = Mockito.mock(Token.class);
    Mockito.when(l.getValue()).thenReturn(null);
  ...
  public void evaluateIntegerShouldReturnIntegerWhenRightsValueIsNull() throws Exception {
    ...
    Token<Integer> r = Mockito.mock(Token.class);
    Mockito.when(r.getValue()).thenReturn(null);
  ...
  public void verifyExpectedReturnTypes() throws Exception {
    Token<Integer> integer = Mockito.mock(Token.class);
    Mockito.when(integer.getValue()).thenReturn(1);

    Token<Long> lng = Mockito.mock(Token.class);
    Mockito.when(lng.getValue()).thenReturn(1L);

    Token<Double> dbl = Mockito.mock(Token.class);
    Mockito.when(dbl.getValue()).thenReturn(1.0D);

    Token<Float> flt = Mockito.mock(Token.class);
    Mockito.when(flt.getValue()).thenReturn(1.0F);
